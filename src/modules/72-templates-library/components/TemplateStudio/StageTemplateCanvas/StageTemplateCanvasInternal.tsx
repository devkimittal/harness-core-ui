...
const StageTemplateCanvasInternal = (_props: unknown, formikRef: TemplateFormRef): JSX.Element => {
  const {
    state: {
      pipeline: { stages },
      pipelineView,
...
export const StageTemplateCanvasInternalWithRef = React.forwardRef(StageTemplateCanvasInternal)
